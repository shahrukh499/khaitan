    ...
    <section className='py-6'>
        <div className='container mx-auto px-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 md:grid-rows-[1fr_1fr]'>
                ...
                <div className='overflow-hidden rounded-lg relative aspect-square md:col-start-1 md:col-end-2 md:row-start-1 md:row-end-2'>
                    <Image 
                        className='rounded-lg hover:scale-105 transition-all duration-300 w-full h-full object-cover' 
                ...
                <div className='overflow-hidden rounded-lg relative aspect-square md:col-start-2 md:col-end-3 md:row-start-1 md:row-end-2'>
                    <Image 
                        className='rounded-lg hover:scale-105 transition-all duration-300 w-full h-full object-cover' 
                ...
                <div className='overflow-hidden rounded-lg relative aspect-2/1 md:col-start-1 md:col-end-3 md:row-start-2 md:row-end-3'>
                    <Image 
                        className='rounded-lg hover:scale-105 transition-all duration-300 w-full h-full object-cover' 
                ...
                <div className='overflow-hidden rounded-lg relative md:col-start-3 md:col-end-4 md:row-start-1 md:row-end-3 md:row-span-2 md:h-full'>
                    ...
                    <div className='absolute bottom-2 left-0 p-5 bg-[#00000098] h-[70vh] m-3 rounded-lg'>
